...
use Pacificnm\Controller\Controller\UpdateController;
...
class UpdateControllerFactory
{
     ...
     * @return \Pacificnm\Controller\Controller\UpdateController
     */
    public function __invoke(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $form = $realServiceLocator->get('Pacificnm\Controller\Form\Form');
